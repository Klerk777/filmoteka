 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Be{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const n=new $e(W,e),i=new $e(W,t);return 0!==this.compare(n,i)}minPost(){return $e.MIN}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let He;class Ve extends Be{static get __EMPTY_NODE(){return He}static set __EMPTY_NODE(e){He=e}compare(e,t){return j(e.name,t.name)}isDefinedOn(e){throw(0,f.assertionError)("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return $e.MIN}maxPost(){return new $e(U,He)}makePost(e,t){return(0,f.assert)("string"==typeof e,"KeyIndex indexValue must always be a string."),new $e(e,He)}toString(){return".key"}}const Ye=new Ve;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gt=new class extends Be{compare(e,t){const n=e.node.compareTo(t.node);return 0===n?j(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return $e.MIN}maxPost(){return $e.MAX}makePost(e,t){const n=ft(e);return new $e(t,n)}toString(){return".value"}};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bt{operationForChild(e){return De(this.path)?new Bt(this.source,be(),this.snap.getImmediateChild(e)):new Bt(this.source,Se(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Ot.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ht{operationForChild(e){if(De(this.path)){const t=this.children.subtree(new Ie(e));return t.isEmpty()?null:t.value?new Bt(this.source,be(),t.value):new Ht(this.source,be(),t)}return(0,f.assert)(ke(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Ht(this.source,Se(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Ot.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}const Wi=/[\[\].#$\/\u0000-\u001F\u007F]/,Ui=/[\[\].#$\u0000-\u001F\u007F]/,ji=10485760,$i=function(e){return"string"==typeof e&&0!==e.length&&!Wi.test(e)},Bi=function(e){return"string"==typeof e&&0!==e.length&&!Ui.test(e)},Hi=function(e){return null===e||"string"==typeof e||"number"==typeof e&&!O(e)||e&&"object"==typeof e&&(0,f.contains)(e,".sv")},Vi=function(e,t,n,i){i&&void 0===t||Yi((0,f.errorPrefix)(e,"value"),t,n)},Yi=function(e,t,n){const i=n instanceof Ie?new Ae(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Oe(i));if("function"==typeof t)throw new Error(e+"contains a function "+Oe(i)+" with contents = "+t.toString());if(O(t))throw new Error(e+"contains "+t.toString()+" "+Oe(i));if("string"==typeof t&&t.length>3495253.3333333335&&(0,f.stringLength)(t)>ji)throw new Error(e+"contains a string greater than "+ji+" utf8 bytes "+Oe(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,s=!1;if(Y(t,((t,r)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(s=!0,!$i(t)))throw new Error(e+" contains an invalid key ("+t+") "+Oe(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var o,a;a=t,(o=i).parts_.length>0&&(o.byteLength_+=1),o.parts_.push(a),o.byteLength_+=(0,f.stringLength)(a),Le(o),Yi(e,r,i),function(e){const t=e.parts_.pop();e.byteLength_-=(0,f.stringLength)(t),e.parts_.length>0&&(e.byteLength_-=1)}(i)})),n&&s)throw new Error(e+' contains ".value" child '+Oe(i)+" in addition to actual children.")}},zi=function(e,t,n,i){if(!(i&&void 0===n||$i(n)))throw new Error((0,f.errorPrefix)(e,t)+'was an invalid key = "'+n+'".  Firebase keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]").')},Gi=function(e,t,n,i){if(!(i&&void 0===n||Bi(n)))throw new Error((0,f.errorPrefix)(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},Ki=function(e,t){const n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!$i(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),Bi(e)}(n))throw new Error((0,f.errorPrefix)(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
